...
def get_settings():
    return {
        ...
        'ethereum_api_server': os.environ.get('ETHEREUM_API_SERVER'),
        'ethereum_chain_id': int(os.environ.get('ETHEREUM_CHAIN_ID', '1')),
        'ethereum_min_height': int(os.environ.get('ETHEREUM_MIN_HEIGHT', '11302490')),
        'ethereum_token_contract': os.environ.get('ETHEREUM_TOKEN_CONTRACT', '0x27702a26126e0B3702af63Ee09aC4d1A084EF628'),
